...
export const ModalDrrosy = ( {heigth, onclose}: Props) => {
  ...
  return (
    <div className={`bg-gradient-to-b from-[#365852] from-10% via-[#422457] via-100%  text-slate-800 absolute w-[80%] h-[85%] left-[10%] rounded-lg border border-white flex flex-col justify-center items-center px-7 max-[1024px]:w-[90%] max-[1024px]:left-[5%] max-[1024px]:px-2 max-[1024px]:h-[80vh]`} style={windowH}>
        ...
        <p className="text-[25px] font-bold pb-2 text-white max-[1024px]:text-[18px] max-[1024px]:mt-5">WordPress website for services</p>  
   
        <ul className='overflow-auto max-[1024px]:overflow-auto'>
          <li className="font-semibold text-start text-white py-2 max-[1024px]:py-0">&#9989; This is a <Wordpress/> website. It was built using the <Elementor/> Pro builder along with extensive <Css/> customization.</li>

          <li className="font-semibold text-start text-white py-2 max-[1024px]:py-0">&#9989; The design process was conducted using <Figma/>. After finalizing the desktop and responsive designs, we proceeded with web development.</li>

          <li className="font-semibold text-start text-white py-2 max-[1024px]:py-0">&#9989; An effective blog post strategy combined with thorough <Seo/> optimization has been implemented to gain traction.</li>

          <li className="font-semibold text-start text-white py-2 max-[1024px]:py-0">&#9989; Security strategies have been implemented to prevent malware infections.</li>

          <li className="font-semibold text-start text-white py-2 max-[1024px]:py-0">&#9989; Hosting and SSL Certificate have been successfully configured.</li>
